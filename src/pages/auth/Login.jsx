...
const Login = () => {
  ...
  const handleCredentialSubmit = async (e) => {
    ...
    try {
      if (roleTab === "ADMIN") {
        ...
        setSuccessMsg(response?.message || "4-digit OTP sent successfully to " + targetEmail);
      } else {
        // Faculty Login: Direct JWT Login without OTP
        const response = await authService.facultyLogin(email, password);
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      await authService.verifyAdminOtp(targetEmail, otp);
      setSuccessMsg("Admin OTP verified successfully! Redirecting...");
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md z-10">
        ...
        <h2 className="mt-4 text-center text-3xl font-extrabold text-white">
          {step === "LOGIN" ? (roleTab === "ADMIN" ? "Sign in as Admin" : "Sign in as Faculty") : "Verify Email OTP"}
        </h2>
            ...
            <form className="space-y-6" onSubmit={handleOtpSubmit}>
              <div>
                ...
                <p className="mt-2 text-xs text-slate-400 text-center">
                  Check your inbox for the 4-digit verification code.
                </p>
              </div>
