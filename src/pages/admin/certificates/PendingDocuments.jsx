                    ...
                    <tr key={doc.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition">
                      ...
                      <td className="px-4 py-3.5 text-right pr-6 space-x-2">
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 rounded-xl inline-flex items-center shadow-xs cursor-pointer"
                        >
                          <CheckCircle2 className="w-3.5 h-3.5 mr-1" /> Verify
                        </button>
                        <button
                          onClick={() => handleReject(doc.id)}
                          className="px-3 py-1.5 text-xs font-bold text-rose-600 bg-rose-50 dark:bg-rose-950/60 border border-rose-200 rounded-xl inline-flex items-center cursor-pointer"
                        >
